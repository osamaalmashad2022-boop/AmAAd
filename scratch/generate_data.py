...
def get_video_html(video_id, title):
    return f'''
<div class="mt-8">
    <h4 class="font-bold text-lg mb-3 text-indigo-700"><i class="fa-brands fa-youtube text-red-600 mr-2"></i> فيديو توضيحي: {title}</h4>
    <div class="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-md bg-gray-900 border-4 border-gray-800">
        <iframe src="https://www.youtube-nocookie.com/embed/{video_id}?rel=0" title="{title}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen referrerpolicy="strict-origin-when-cross-origin" class="w-full h-64 md:h-96"></iframe>
    </div>
    <div class="text-center mt-3">
        <a href="https://www.youtube.com/watch?v={video_id}" target="_blank" class="inline-block bg-red-50 text-red-600 hover:bg-red-600 hover:text-white transition font-bold py-2 px-6 rounded-full text-sm border border-red-200 shadow-sm">
...
def get_img_html(seed, alt):
    return f'''
<div class="mb-8 rounded-2xl overflow-hidden shadow-lg border-4 border-white">
    <img src="https://picsum.photos/seed/{seed}/800/400" alt="{alt}" class="w-full h-64 md:h-80 object-cover transform hover:scale-105 transition duration-500">
</div>
'''
...
modules = [
    {
                ...
                "items": [
                    {
                        ...
                        "content": get_img_html("tech1", "Explorer using tech") + """
                        ...
                        """ + get_video_html("vmPredMTXpg", "National Geographic Explorer")
                    },
                    {
                        ...
                        "content": get_img_html("tech2", "Computer Accessories") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech3", "Global Networks") + """
                        ...
                        """ + get_video_html("Dxcc6ycZ73M", "What is the Internet?")
                    },
                    {
                        ...
                        "content": get_img_html("tech4", "Internet of Things") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech5", "Troubleshooting") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech8", "File Management") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech9", "Web Search") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech10", "Data Sharing") + """
                ...
                "items": [
                    {
                        ...
                        "content": get_img_html("tech6", "Security") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech7", "Password Security") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech11", "Privacy Settings") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech12", "Copyright") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("tech13", "Reliable Sources") + """
        ...
        "quiz": [
            { "q": "أصغر وحدة لقياس سعة التخزين في الكمبيوتر هي:", "options": ["البت (Bit)", "البايت (Byte)", "الميجابايت (MB)", "الجيجابايت"], "correct": 0 },
            { "q": "شبكة الإنترنت هي شبكة مغلقة مخصصة لمؤسسة واحدة فقط وتتميز بالخصوصية.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "لربط جهاز الكمبيوتر بشبكة الإنترنت بشكل مباشر ومستقر نحتاج إلى:", "options": ["كابل إيثرنت وجهاز توجيه", "طابعة وسماعات", "فلاشة ميموري", "لوحة مفاتيح"], "correct": 0 },
            { "q": "لحل مشكلة تجمد الشاشة في الكمبيوتر، نضغط على (Ctrl + Alt + Delete) لإنهاء البرنامج.", "options": ["صح", "خطأ"], "correct": 0 },
            { "q": "يُنصح دائماً باستخدام كلمات مرور ........... لحماية حساباتك من الاختراق.", "options": ["تحتوي على اسمك", "قصيرة مكونة من أرقام فقط", "طويلة وتحتوي على رموز وحروف مختلفة", "سهلة التخمين"], "correct": 2 },
            { "q": "يُسمح لك بنسخ أعمال ومقالات الآخرين من الإنترنت ونسبتها لنفسك دون ذكر المصدر.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "من أشكال التصيد الاحتيالي (الاحتيال لسرقة البيانات) عبر الرسائل النصية القصيرة يُسمى:", "options": ["Phishing", "Smishing", "Downloading", "Hacking"], "correct": 1 },
            { "q": "حقوق الطبع والنشر (Copyright) تهدف إلى حماية إبداعات المؤلفين والمخترعين قانونياً.", "options": ["صح", "خطأ"], "correct": 0 },
            { "q": "عند بدء كتابة معادلة حسابية في برنامج الجداول الحسابية (Excel) يجب أن تبدأ الخلية بعلامة:", "options": ["+", "-", "=", "*"], "correct": 2 },
            { "q": "الشبكة العنكبوتية العالمية التي نتصفح من خلالها المواقع يُرمز لها بالرمز:", "options": ["WWW", "LAN", "CPU", "RAM"], "correct": 0 },
            { "q": "للبحث عن كلمة محددة جداً بالترتيب على الإنترنت، نضعها بين:", "options": ["علامتي ناقص (- -)", "علامتي تنصيص (\" \")", "قوسين ( )", "نجمتين (* *)"], "correct": 1 },
            { "q": "من أمثلة المصادر الموثوقة للمعلومات:", "options": ["المدونات الشخصية", "ويكيبيديا", "بنك المعرفة المصري", "منشورات فيسبوك"], "correct": 2 }
        ]
    },
    {
        "id": 1,
                ...
                "items": [
                    {
                        ...
                        "content": get_img_html("islam1", "Quran") + """
                        ...
                        """ + get_video_html("_nx76MlMzFE", "تلاوة سورة المؤمنون")
                    },
                    {
                        ...
                        "content": get_img_html("islam2", "Tajweed") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("islam6", "Modesty") + """
                ...
                "items": [
                    {
                        ...
                        "content": get_img_html("islam3", "Cooperation") + """
                    ...
                    },
                    {
                        ...
                        "content": get_img_html("islam7", "Knowledge") + """
                ...
                "items": [
                    {
                        ...
                        "content": get_img_html("islam8", "History") + """
        ...
        "activities": [
            { "title": "نشاط قرآني وتجويد", "desc": "استخرج 10 كلمات من سورة المؤمنون بها أحكام قلقلة، وبين نوع القلقلة في جدول (صغرى أم كبرى)." },
            { "title": "محاكاة حساب الزكاة", "desc": "افترض أن مسلماً يمتلك مبلغ 100 ألف جنيه ومر عليه الحول. احسب قيمة الزكاة المستحقة واقترح توزيعها." },
            { "title": "البحث في السيرة", "desc": "اكتب بحثاً صغيراً عن دور عثمان بن عفان رضي الله عنه في تجهيز جيش العسرة لغزوة تبوك." }
        ],
        "quiz": [
            { "q": "سورة المؤمنون هي سورة مدنية نزلت بعد الهجرة.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "من صفات المؤمنين المفلحين التي ذُكرت في بداية سورة المؤمنون:", "options": ["الخشوع في الصلاة", "كثرة المزاح واللعب", "حب جمع المال", "تجنب العمل"], "correct": 0 },
            { "q": "حروف القلقلة في علم التجويد مجموعة في عبارة:", "options": ["يرملون", "قطب جد", "حي طهر", "خص ضغط قظ"], "correct": 1 },
            { "q": "الإيمان بالملائكة هو الركن الثاني من أركان الإيمان الستة.", "options": ["صح", "خطأ"], "correct": 0 },
            { "q": "عندما يأتي حرف (القاف) ساكناً في وسط الكلمة مثل (يَقْطَعُونَ) يسمى هذا الحكم:", "options": ["إظهار حلقي", "قلقلة كبرى", "قلقلة صغرى", "إدغام"], "correct": 2 },
            { "q": "أمرنا الإسلام بالتعاون على الإثم والعدوان.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "يسمى جيش المسلمين في غزوة تبوك بـ:", "options": ["جيش الفتح", "جيش العسرة", "جيش بدر", "جيش اليرموك"], "correct": 1 },
            { "q": "الصحابي الذي تبرع بمال عظيم لتجهيز جيش العسرة هو:", "options": ["عثمان بن عفان", "خالد بن الوليد", "أسامة بن زيد", "بلال بن رباح"], "correct": 0 },
            { "q": "العلم النافع في الإسلام هو الذي لا يصاحبه عمل.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "المراد باللغو في سورة المؤمنون:", "options": ["الكلام المفيد", "الكلام الباطل الذي لا فائدة منه", "السكوت الطويل", "التسبيح"], "correct": 1 }
        ]
    },
    {
        "id": 2,
        "title": "التربية الدينية الإسلامية",
        "badge": "الصف الثاني الثانوي - الترم الثاني",
        "icon": "fa-book-quran",
        "desc": "يشتمل على شرح نظام الحكم في الإسلام، الإيمان بالقضاء والقدر، وتفسير سورة الحجرات.",
        "sections": [
            {
                "title": "الوحدة الأولى: الإيمان",
                "items": [
                    {
                        "title": "الدرس 1: الإيمان باليوم الآخر والقضاء والقدر",
                        "shortDesc": "ثمرات الإيمان والفرق بين التوكل والتواكل.",
                        "icon": "fa-scale-balanced",
                        "objectives": [
                            "أن يوضح أثر الإيمان بالآخرة في تهذيب سلوك الفرد.",
                            "أن يميز بوضوح بين التوكل (الإيجابي) والتواكل (السلبي)."
                        ],
                        "content": get_img_html("islam4", "Faith") + """
                    ...
                    },
                    {
                        ...
                        "shortDesc": "طبيعة الملائكة ووظائفهم.",
                        "icon": "fa-dove",
                        "objectives": [
                            "أن يعرف الطالب من هم الملائكة.",
                            "أن يعدد أسماء بعض الملائكة وأعمالهم الموكلة إليهم."
                        ],
                        "content": get_img_html("islam9", "Angels") + """
                            <h3 class="text-2xl font-bold text-dark mt-6 mb-4">طبيعة الملائكة ووظائفهم</h3>
                            <p class="mb-4 text-gray-700 leading-relaxed text-lg">الملائكة مخلوقات من نور، لا يعصون الله ما أمرهم ويفعلون ما يؤمرون. من أشهرهم جبريل عليه السلام الموكل بالوحي، وميكائيل الموكل بالمطر.</p>
                        """
                    }
                ]
            },
            {
                "title": "الوحدة الثانية: سورة الحجرات",
                "items": [
                    {
                        "title": "سورة الحجرات (تفسير وحفظ)",
                        "shortDesc": "الأخلاق والآداب الاجتماعية في سورة الحجرات.",
                        "icon": "fa-book-open",
                        "objectives": [
                            "أن يشرح سبب تسمية السورة (بسورة الأخلاق).",
                            "أن يستخرج الآداب المنهي عنها (السخرية، التنابز، التجسس)."
                        ],
                        "content": get_img_html("islam5", "Hujurat") + """
                            <h3 class="text-2xl font-bold text-dark mt-6 mb-4">سورة الأخلاق والآداب</h3>
                            <p class="mb-4 text-gray-700 leading-relaxed text-lg">سورة الحجرات تضمنت قواعد ذهبية لبناء مجتمع متماسك.</p>
                            <h4 class="font-bold text-xl text-dark mb-3">المنهيات والأمراض الاجتماعية:</h4>
                            <ul class="list-disc list-inside mb-6 space-y-2 text-gray-700 text-lg">
                                <li><strong>تجنب الشائعات:</strong> أمرت بالتثبت من الأخبار قبل نشرها لتجنب الفتنة.</li>
                                <li><strong>أمراض القلوب:</strong> السخرية من الآخرين، اللمز، وسوء الظن.</li>
                                <li><strong>الغيبة والتجسس:</strong> نهت عن تتبع عورات الناس، وشبهت الغيبة كمن يأكل لحم أخيه الميت!</li>
                            </ul>
                        """ + get_video_html("vqZLMW9MpZQ", "تلاوة رائعة لسورة الحجرات")
                    }
                ]
            },
            {
                "title": "الوحدة الثالثة: نظام الحكم في الإسلام",
                "items": [
                    {
                        "title": "الدرس 1: أسس الحكم الشورى والعدل",
                        "shortDesc": "مبادئ الحكم الرشيد في الإسلام.",
                        "icon": "fa-landmark",
                        "objectives": [
                            "أن يدرك الطالب أهمية العدل والمساواة في الإسلام.",
                            "أن يوضح مبدأ الشورى وكيفية تطبيقه."
                        ],
                        "content": get_img_html("islam10", "Justice") + """
                            <h3 class="text-2xl font-bold text-dark mt-6 mb-4">أسس الحكم السليم</h3>
                            <p class="mb-4 text-gray-700 leading-relaxed text-lg">قام نظام الحكم في الإسلام على قواعد متينة أهمها العدل والمساواة بين جميع المواطنين دون تمييز، بالإضافة إلى تطبيق مبدأ الشورى في اتخاذ القرارات الهامة لضمان سلامة الأمة.</p>
                        """
                    }
                ]
            }
        ...
        "activities": [
            { "title": "محاكاة نظام الشورى", "desc": "إجراء انتخابات عملية لرواد الفصل لتطبيق مبدأ الشورى والمساواة عملياً." },
            { "title": "تحليل سورة الحجرات", "desc": "كتابة مقال تحليلي يربط بين الآداب المذكورة في سورة الحجرات ومخاطر (التنمر الإلكتروني)." },
            { "title": "نقاش التوكل والتواكل", "desc": "سرد مواقف حياتية توضح تطبيقاً عملياً لمفهوم (التوكل) بدلاً من (التواكل)." }
        ],
        "quiz": [
            { "q": "المسلم المؤمن بالقضاء والقدر يترك العمل والأسباب معتمداً على أن كل شيء مكتوب.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "النتيجة المترتبة على رفع الصوت أمام الرسول كما ورد في أول سورة الحجرات هي:", "options": ["إحباط وبطلان ثواب العمل", "زيادة الرزق", "لا يترتب عليها شيء", "دخول الجنة"], "correct": 0 },
            { "q": "المساواة والعدل من أسس نظام الحكم الراسخة في الإسلام.", "options": ["صح", "خطأ"], "correct": 0 },
            { "q": "السورة القرآنية التي تُسمى بـ 'سورة الأخلاق والآداب' لاحتوائها على نواهي عن السخرية والغيبة هي:", "options": ["سورة البقرة", "سورة الحجرات", "سورة النور", "سورة التوبة"], "correct": 1 },
            { "q": "الغيبة كما وصفتها سورة الحجرات تشبه:", "options": ["الكذب الصريح", "أكل لحم الأخ الميت", "السرقة", "شهادة الزور"], "correct": 1 },
            { "q": "الملك الموكل بالوحي للأنبياء هو:", "options": ["ميكائيل", "إسرافيل", "جبريل", "ملك الموت"], "correct": 2 },
            { "q": "من مبادئ الحكم في الإسلام الاستبداد بالرأي وتجاهل الشورى.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "التوكل الصحيح هو الأخذ بالأسباب مع تفويض الأمر لله.", "options": ["صح", "خطأ"], "correct": 0 },
            { "q": "التجسس وتتبع عورات الناس أمر مباح في الإسلام.", "options": ["صح", "خطأ"], "correct": 1 },
            { "q": "الملائكة مخلوقات من نار.", "options": ["صح", "خطأ"], "correct": 1 }
        ]
    }
]

with open("c:\\Users\\mm\\Desktop\\AAA\\js\\data.js", "w", encoding="utf-8") as f:
    f.write("const modulesData = " + json.dumps(modules, ensure_ascii=False, indent=4) + ";\n")
